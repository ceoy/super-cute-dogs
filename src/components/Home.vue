        ...
        <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
                <div class="mdc-layout-grid__cell">
                    <div class="mdc-card">
                        <div class="my-card--one mdc-card__media mdc-card__media--16-9" />
                        <div class="card-content">
                            <div class="mdc-typography--headline6">
                                The Cutest
                            </div>

                            <div class="mdc-typography--body2 card-body">
                                This Dog is just perfect. He is such a good boi!
                            </div>
                        </div>
                    </div>  
                </div>
                <div class="mdc-layout-grid__cell">
                    <div class="mdc-card">
                        <div class="my-card--two mdc-card__media mdc-card__media--16-9" />
                        <div class="card-content">
                            <div class="mdc-typography--headline6">
                                The Fluffiest
                            </div>
                            ...
                            <div class="mdc-typography--body2 card-body">
                                This dog is cute and fluffy. He is such a good boi!
                            </div>
                        </div>
                    </div>  
                </div>
                <div class="mdc-layout-grid__cell">
                    <div class="mdc-card">
                        <div class="my-card--three mdc-card__media mdc-card__media--16-9" />
                        <div class="card-content">
                            <div class="mdc-typography--headline6">
                                The Sleepiest
                            </div>
                            ...
                            <div class="mdc-typography--body2 card-body">
                                This dog is just so sleepy and cute. He is such a good boi! {{ title }}
                            </div>
                        </div>
                    </div>  
                </div>
...
<style lang="scss">
    ...
    .my-card--one {
        background-image: url("../assets/dogs/n02111889_1772.jpg")
        
    }
    .my-card--two {
        background-image: url("../assets/dogs/n02111889_899.jpg")
    }
    .my-card--three {
        background-image: url("../assets/dogs/n02111889_6631.jpg")
    }
</style>
